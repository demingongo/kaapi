...
| ----------------------------- | --------------------------- | ------- | ------------------------------------------------------------------------------------- |
| `packages/server`             | `@kaapi/server`             | 0.0.42  | Low-level Hapi.js wrapper with built-in `kaapi-auth` Bearer scheme                    |
| `packages/kaapi`              | `@kaapi/kaapi`              | 0.0.42  | **Main framework** — wraps server, adds logging, messaging, plugins, docs             |
| `packages/kafka-messaging`    | `@kaapi/kafka-messaging`    | 0.0.42  | KafkaJS-based `IMessaging` implementation                                             |
| `packages/oauth2-auth-design` | `@kaapi/oauth2-auth-design` | 0.0.42  | OAuth2/OIDC auth flows as Kaapi plugins (Auth Code, Client Credentials, Device, OIDC) |
| `packages/cli`                | `@kaapi/cli`                | 0.0.42  | Interactive `kaapi` CLI for scaffolding plugins, auth designs, etc.                   |
