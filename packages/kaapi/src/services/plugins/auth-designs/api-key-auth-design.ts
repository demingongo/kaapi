...
export class APIKeyAuthDesign extends AuthDesign {
    ...
    docs(): ApiKeyUtil | undefined {
        const docs = new ApiKeyUtil(this.strategyName).setApiKeyLocation(this.apiKeyLocation).setKey(this.key);
                            ...
                            if (result) {
                                ...
                                if (message) {
                                    return h.unauthenticated(
                                        Boom.unauthorized(
                                            message,
                                            (ApiKeyLocation.header && settings.headerTokenType) || strategyName
                                        ),
                                        {
