...
export class OpenAPIMixHelper extends DelegatingHelper<OpenAPIHelperInterface> implements OpenAPIHelperInterface {
    ...
    getFirstItem() {
        return this.helper.getFirstItem();
    }
    getChildren() {
        return this.helper.getChildren();
    }
    getAlternatives() {
        return this.helper.getAlternatives();
    }
    hasStyle?() {
        return this.helper.hasStyle?.() || false;
    }
    getStyle?() {
        return this.helper.getStyle?.();
    }
    hasAdditionalProperties?() {
        return this.helper.hasAdditionalProperties?.() || false;
    }
    getAdditionalProperties?() {
        return this.helper.getAdditionalProperties?.();
    }
    hasRef?() {
        return this.helper.hasRef?.() || false;
    }
    getRef?() {
        return this.helper.getRef?.();
    }
    hasDiscriminator?() {
        return this.helper.hasDiscriminator?.() || false;
    }
    getDiscriminator?() {
        return this.helper.getDiscriminator?.();
    }
    hasXml?() {
        return this.helper.hasXml?.() || false;
    }
    getXml?() {
        return this.helper.getXml?.();
    }
    hasExamples?() {
        return this.helper.hasExamples?.() || false;
    }
    getExamples?() {
        return this.helper.getExamples?.();
    }
    hasEncoding?() {
        return this.helper.hasEncoding?.() || false;
    }
    getEncoding?() {
        return this.helper.getEncoding?.();
    }
    isValid() {
    ...
    isUnique() {
        return this.helper.isUnique();
    }
    hasDefaultValue() {
        return this.helper.hasDefaultValue();
    }
    getDefaultValue() {
        return this.helper.getDefaultValue();
    }
    hasExampleValue() {
        return this.helper.hasExampleValue();
    }
    getExampleValue() {
        return this.helper.getExampleValue();
    }
    isDeprecated() {
        return this.helper.isDeprecated();
    }
    allowsEmptyValue() {
        return this.helper.allowsEmptyValue();
    }
    getEnum() {
        return this.helper.getEnum();
    }
    hasMin() {
        return this.helper.hasMin();
    }
    hasMax() {
        return this.helper.hasMax();
    }
    getMin() {
        return this.helper.getMin();
    }
    getMax() {
        return this.helper.getMax();
    }
    getUnit() {
        return this.helper.getUnit();
    }
}
...
export class PostmanMixHelper extends DelegatingHelper<PostmanHelperInterface> implements PostmanHelperInterface {
    ...
    hasContentType?() {
        return this.helper.hasContentType?.() || false;
    }
    getContentType?() {
        return this.helper.getContentType?.();
    }
    hasDescriptionType?() {
        return this.helper.hasDescriptionType?.() || false;
    }
    getDescriptionType?() {
        return this.helper.getDescriptionType?.();
    }
    hasXml?() {
        return this.helper.hasXml?.() || false;
    }
