...
module.exports = {
    forbidden: [
        ...
        },
        {
            ...
            severity: 'ignore', // @custom because Dependency Cruiser doesn’t know the intent behind dependencies and peerDependencies
            from: {},
            to: {
        ...
        },
        {
            ...
            severity: 'ignore', // @custom because monorepo so off course it is going to fail
            from: {},
            to: {
...
// generated: dependency-cruiser@17.0.2 on 2025-10-12T01:39:04.128Z
