...
describe('ValidatorValibot Edge Cases', () => {
    ...
    it('should handle optional and default fields correctly', async () => {
        app.base()
            .valibot({
                query: v.object({
                    name: v.optional(v.pipe(v.string(), v.trim(), v.nonEmpty(), v.description('The name')), 'World'),
    ...
    it('should validate union types', async () => {
        app.base()
            .valibot({
                query: v.object({
                    user: v.union([v.literal('authenticated'), v.literal('anonymous')]),
                }),
            })
            .route({
                method: 'GET',
        ...
        app.base()
            .valibot({
                query: v.object({
                    ...
                    toe: v.optional(v.array(v.boolean())),
                }),
            })
            .route({
                method: 'GET',
