...
export type OAuth2DeviceCodeTokenErrorBody = {
    error:
        | DeviceFlowOAuth2ErrorCodeType
        | typeof StandardOAuth2ErrorCode.INVALID_GRANT
        | typeof StandardOAuth2ErrorCode.INVALID_CLIENT;
...
export type IOAuth2DeviceAuthTokenRoute<Refs extends ReqRef = ReqRefDefaults> = IOAuth2TokenRoute<
    OAuth2DeviceAuthTokenParams,
    Refs
>;

export class OAuth2DeviceAuthTokenRoute<Refs extends ReqRef = ReqRefDefaults>
    extends OAuth2TokenRoute<OAuth2DeviceAuthTokenParams, Refs>
 ...
 */
export type DeviceAuthTokenGenerator<Refs extends ReqRef = ReqRefDefaults> = TokenGenerator<
    OAuth2DeviceAuthTokenParams,
    Refs,
    OAuth2DeviceCodeTokenErrorBody
>;

export class DefaultOAuth2DeviceAuthTokenRoute<Refs extends ReqRef = ReqRefDefaults>
    extends OAuth2DeviceAuthTokenRoute<Refs>
    implements DefaultOAuth2TokenRoute<OAuth2DeviceAuthTokenParams, Refs, OAuth2DeviceCodeTokenErrorBody>
{
    ...
    constructor() {
        super('/oauth2/token', async (props, req, h) => {
            ...
            try {
                ...
                return h
                    .response({ error: DeviceFlowOAuth2ErrorCode.ACCESS_DENIED, error_description: `${err}` })
                    .code(400);
            }
