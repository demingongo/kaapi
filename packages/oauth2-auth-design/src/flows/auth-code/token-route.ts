...
export type IOAuth2ACTokenRoute<Refs extends ReqRef = ReqRefDefaults> = IOAuth2TokenRoute<OAuth2ACTokenParams, Refs>;

export class OAuth2ACTokenRoute<Refs extends ReqRef = ReqRefDefaults>
    extends OAuth2TokenRoute<OAuth2ACTokenParams, Refs>
...
export class DefaultOAuth2ACTokenRoute<Refs extends ReqRef = ReqRefDefaults>
    extends OAuth2ACTokenRoute<Refs>
    implements DefaultOAuth2TokenRoute<OAuth2ACTokenParams, Refs>
{
            ...
            if (!props.clientSecret && !props.codeVerifier) {
                return h
                    .response({
                        ...
                        error_description: "Token request was missing 'client_secret' or 'code_verifier'.",
                    })
                    .code(400);
            }
