...
export function createMatchOAuth2ErrorCode<R>(handlers: Partial<Record<AnyOAuth2ErrorCodeType, () => R>>) {
...
> = (
    ...
    | Promise<OAuth2TokenResponseBody | IOAuth2TokenResponse | Err | null>
...
export type IOAuth2RefreshTokenRoute<Refs extends ReqRef = ReqRefDefaults> = IOAuth2TokenRoute<
    OAuth2RefreshTokenParams,
    Refs
>;

export class OAuth2RefreshTokenRoute<Refs extends ReqRef = ReqRefDefaults>
    extends OAuth2TokenRoute<OAuth2RefreshTokenParams, Refs>
    implements IOAuth2RefreshTokenRoute<Refs>
{
    static buildDefault<Refs extends ReqRef = ReqRefDefaults, Err extends { error: string } = OAuth2ErrorBody>() {
...
>
    ...
    implements DefaultOAuth2TokenRoute<OAuth2RefreshTokenParams, Refs, Err>
{
...
export class JWKSRoute<Refs extends ReqRef = ReqRefDefaults> implements IJWKSRoute<Refs> {
    static buildDefault<GetRefs extends ReqRef = ReqRefDefaults>() {
...
export class DefaultJWKSRoute<Refs extends ReqRef = ReqRefDefaults> extends JWKSRoute<Refs> {
    constructor() {
        super('/oauth2/keys');
    }
...
export interface OAuth2SingleAuthFlow {
    ...
    handleToken<Refs extends Partial<Record<keyof ReqRefDefaults, unknown>> = ReqRefDefaults>(
        t: KaapiTools,
        request: Request<Refs>,
        h: ResponseToolkit<Refs>
    ): Promise<
    ...
    handleRefreshToken?<Refs extends Partial<Record<keyof ReqRefDefaults, unknown>> = ReqRefDefaults>(
        t: KaapiTools,
        request: Request<Refs>,
        h: ResponseToolkit<Refs>
    ): Promise<
