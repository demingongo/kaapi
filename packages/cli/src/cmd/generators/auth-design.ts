...
const COOKIE_NAME = '${this.#values.keyName}';
...
export const ${camelCase(this.#values.strategyName)} = new CookieSessionAuthDesign({
    strategyName: '${this.#values.strategyName}',
    key: COOKIE_NAME,
    auth: {
