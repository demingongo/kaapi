...
export const PORT: number =
  process.env.PORT && !isNaN(parseInt(process.env.PORT)) ? parseInt(process.env.PORT) : 3000;
export const EXTERNAL_URI: string =
  process.env.EXTERNAL_URI || `http://${SERVER_BIND_ADDRESS}:${PORT}`;
