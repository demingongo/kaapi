        ...
        (route) =>
            route
                ...
                .setGETResponseRenderer(
                    async ({ usernameField, passwordField, error, errorMessage }, params, req, h) => {
                        // db query
                ...
                .setPOSTErrorRenderer(
                    async ({ usernameField, passwordField, error, errorMessage, statusCode }, _params, _req, h) => {
                        return h
                            .view('authorization-page', { usernameField, passwordField, error, errorMessage })
                            .code(statusCode);
                    }
                )
                .generateCode(
